package com.xy.home.xiao20170222;
...
public class Receiver {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 第六步：我们最后使用JMS规范的TextMessage形式创建数据（通过Session对象创建），并用MessageProducer的send方法发送数据。同理客户端使用receive方法接收数据
        while (true) {
            // 注意receive方法的区别
        ...
        // 第七步：关闭Connection对象，会递归关闭所有，比如Session
        if(connection != null) {
            connection.close();
        }
    }
